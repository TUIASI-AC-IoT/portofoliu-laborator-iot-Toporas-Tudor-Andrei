...
void start_mdns_service()
{
    ...
    //set hostname
    mdns_hostname_set("esp32-toporas");
...
void app_main(void)
{
    ...
    //Pornire mod STA + scanare SSID-uri disponibile
    ...
    //Initializare mDNS (daca mai ramana timp) 
    start_mdns_service();   

    

    //Pornire server web (si config specifice in http-server.c)
